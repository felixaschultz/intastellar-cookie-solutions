...
window.addEventListener("DOMContentLoaded", function () {
    ...
    setTimeout(() => {
        console.log(document.querySelector("[name=intastellar-solutions-sharinglibrary-iframe]"));
        document.querySelector("[name=intastellar-solutions-sharinglibrary-iframe]").postMessage("This is a test message", document.querySelector("[name=intastellar-solutions-sharinglibrary-iframe]").src);
    },500)
