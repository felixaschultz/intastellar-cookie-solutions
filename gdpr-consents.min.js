...
window.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector("[name=intastellar-solutions-sharinglibrary-iframe]").contentWindow.postMessage("This is a test message", document.querySelector("[name=intastellar-solutions-sharinglibrary-iframe]").src);
