...
if (!(window.location.hostname === "intastellarconsents.com" && window.location.pathname.startsWith("/gdpr"))) {
    ...
    let intaConsentsObjectVariable = {
        ...
        // All code below this point should be indented one level inside this block
        // (from line 51 onward)

        // You may want to re-indent the rest of the file for clarity, but this change will block execution on excluded pages.
        // --- End main consent script logic ---
