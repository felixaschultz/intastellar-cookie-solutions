...
function intaFloatingUpdateSaveButtonText(settingsSaveLang) {
    ...
    document.querySelectorAll(".intastellarCookie-settings__btn.--save").forEach(function (btn) {
        btn.innerText = label;
    });
}
...
window._IntastellarConsentsBanner.setAttribute("class", "intastellarCookieConstents");
