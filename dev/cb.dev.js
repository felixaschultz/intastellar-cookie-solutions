...
function openVendorList() {
    ...
    getVendorsForUI().then(vendors => {
        ...
        // Patch: Attach vendor consent/legit state to all Save buttons (multiple language sections)
...
if (intastellarCookieLanguage != null) {
    if (intastellarCookieLanguage === "da" || intastellarCookieLanguage === "da-DK") {
        ...
        ${(window.INTA.settings.tcf) ? `<button class="openVendorList" onclick="openVendorList()">Vendor list</button>` : ""}
